...
#'
#' @param dataframe A data frame, usually the training data.
#' @param formula The formula used to create the model.
#'
...
#'
#' @examples
#' recipe_scale_center(training_cars, mpg ~ hp)
#' recipe_scale_center(training_cars, mpg ~ hp + cyl)
