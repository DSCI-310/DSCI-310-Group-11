...
```{r correl-graph, fig.cap="Correlation matrix between pairs of variables associated with each other."}
...
```{r correl-graph-lv, fig.cap="Correlation Matrix Between Pairs of Variables with Large Correlation Values"}
