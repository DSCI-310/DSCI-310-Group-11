...
Sample of the first ten rows of the data set.
...
We split the data into a 75:25 training and testing split, which is then scaled and centered to ensure that all variables are on a comparable scale.

Then, we plot a correlation matrix to determine if any pairs of variables are associated with each other.

```{r correl-graph, fig.cap="Correlation matrix between pairs of variables associated with each other.",  out.width="90%", out.height="85%", echo=FALSE}
