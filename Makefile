...
data/forestfires.csv : src/R/data_loading.R
		Rscript src/R/data_loading.R https://archive.ics.uci.edu/ml/machine-learning-databases/forest-fires/forestfires.csv data
		
# tidying the data
data/cleaned_data.csv : data/forestfires.csv src/R/data_tidying.R
		Rscript src/R/data_tidying.R data/forestfires.csv data

# data pre-processing: split into training and testing sets and scale and center
...
data/scaled_and_centered_training_data.csv : data/cleaned_data.csv src/R/data_splitting.R
		Rscript src/R/data_splitting.R data/cleaned_data.csv data
...
# render report
notebooks/forest-fire-analysis.html : notebooks/forest-fire-analysis.Rmd  results/correlation_graph.png results/correlation_graph_selected.png results/best_k.csv results/testing_rmse.csv
		Rscript -e "rmarkdown::render('notebooks/forest-fire-analysis.Rmd')"

clean:
		rm -f data/forestfires.csv data/training_data.csv data/testing_data.csv 
